...
import { BASE_URL, LOGO_URL } from "../config/dev.enviromental";
...
function SendMail() {
  ...
  const sendmail = async () => {
    const link = await fetch(`${BASE_URL}/api/v1/auth/sendlink`, {
      method: "POST",
      headers: {
      ...
      <div className="login_main_wrapper">
        <div className="login_authContent">
          <div className="login_sub_wrapper">
            ...
            <br />
            <form className="from_auth dsfgsdgsd" onSubmit={handelsend}>
