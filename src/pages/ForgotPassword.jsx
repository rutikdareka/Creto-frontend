...
function ForgotPassword() {
  ...
  const forgotpass = async () => {
    const newpass = await fetch(
      `${BASE_URL}/api/v1/auth/forgotPassword/${id}/${token}`,
      {
        method: "POST",
        headers: {
  ...
  const setnewpassword = (e) => {
    ...
    if (cpassword === password) {
      ...
      toast.error("pls same type password");
    }
  };
      ...
      <div className="login_main_wrapper">
        <div className="login_authContent">
          <div className="login_sub_wrapper">
            ...
            <br />
            <form className="from_auth dsfgsdgsd" onSubmit={setnewpassword}>
              ...
              {!isValidP && (
                <span className={`error`}>
                  Password Include min 8 char, special char,numbers,Upper and
                  lower letter
                </span>
              )}
            ...
            <footer>
              ...
              <div className="text">
                © 2023 Creto - created with ♥ in Mumbai
              </div>
            </footer>
          </div>
        </div>
